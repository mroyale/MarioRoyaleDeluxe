...
BlastObject.PARAMS = [{'name': 'Delay', 'type': "int"}, {'name': "Impulse", 'type': "float"}];

BlastObject.ANIMATION_RATE = 6;

BlastObject.DELAY_DEFAULT = 180;
BlastObject.IMPULSE = 0.83;
BlastObject.DRAG = .95;
BlastObject.FALL_SPEED_ACCEL = .025;
BlastObject.SOFFSET = vec2.make(.15,.15);

BlastObject.SPRITE = {};
BlastObject.SPRITE_LIST = [
  {NAME: "IDLE0", ID: 0x00, INDEX: 0x0079},
  {NAME: "IDLE1", ID: 0x01, INDEX: 0x007A},
  {NAME: "IDLE2", ID: 0x02, INDEX: 0x007B}
];
...
BlastObject.STATE_LIST = [
  {NAME: "IDLE", ID: 0x00, SPRITE: [BlastObject.SPRITE.IDLE0,BlastObject.SPRITE.IDLE1,BlastObject.SPRITE.IDLE2]}
];
